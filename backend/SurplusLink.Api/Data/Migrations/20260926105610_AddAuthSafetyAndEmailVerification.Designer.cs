...
namespace SurplusLink.Api.Data.Migrations
{
    ...
    [Migration("20260926105610_AddAuthSafetyAndEmailVerification")]
    partial class AddAuthSafetyAndEmailVerification
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SurplusLink.Api.Models.BuyerRequest", b =>
                {
                    ...
                    b.Property<Guid?>("RecommendedMatchId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("Matches", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Matches_RejectionReason", "(\"Status\" IN ('REJECTED', 'ROUTE_FAILED') AND length(btrim(\"RejectionReason\")) > 0 AND \"RejectionReason\" IS NOT NULL) OR (\"Status\" NOT IN ('REJECTED', 'ROUTE_FAILED') AND \"RejectionReason\" IS NULL)");
            ...
            modelBuilder.Entity("SurplusLink.Api.Models.MobileHandoff", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("MobileHandoffs", (string)null);
                });
            ...
            modelBuilder.Entity("SurplusLink.Api.Models.MobileHandoff", b =>
                {
                    ...
                    b.HasOne("SurplusLink.Api.Models.User", "RedeemedByUser")
                        .WithMany()
