...
{
    /// <inheritdoc />
    public partial class AddOffersAndTransactions : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Offers_BuyerSeller_Different", "\"BuyerId\" <> \"SellerId\"");
                    table.CheckConstraint("CK_Offers_Quantity_Positive", "\"Quantity\" > 0");
                    table.CheckConstraint("CK_Offers_TotalValue_Positive", "\"TotalValue\" > 0");
                    table.CheckConstraint("CK_Offers_UnitValue_Positive", "\"UnitValue\" > 0");
                    table.ForeignKey(
                        name: "FK_Offers_Matches_MaterialMatchId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Transactions_BuyerSeller_Different", "\"BuyerId\" <> \"SellerId\"");
                    table.CheckConstraint("CK_Transactions_Quantity_Positive", "\"Quantity\" > 0");
                    table.CheckConstraint("CK_Transactions_ReservedQuantity_Range", "\"ReservedQuantity\" >= 0 AND \"ReservedQuantity\" <= \"Quantity\"");
                    table.CheckConstraint("CK_Transactions_TotalValue_Positive", "\"TotalValue\" > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Offers_MaterialMatchId",
                table: "Offers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Offers_Status_CreatedAtUtc",
                table: "Offers",
